                  ...
                  <div className="col-xl-12">
                    <div className="main-slider__content">
                      <div className="main-slider__sub-title-box">
                        ...
                        <p className="main-slider__sub-title">SOFTWARE COMPANY</p>
                      </div>
                      ...
                      <div className="main-slider__btn-and-call-box">
                        ...
                        <div className="main-slider__call">
                          ...
                          <div className="main-slider__call-number">
                            <p>Need help?</p>
                            <h5>
                              <Link to="tel:8969361100">8969361100</Link>
                            </h5>
                          </div>
                        </div>
                      </div>
                ...
                <div className="row">
                  <div className="col-xl-12">
                    <div className="main-slider__content">
                      ...
                      <h2 className="main-slider__title">
                      "Beyond Solutions, Into " <span>Success.</span> <br /> 
                      </h2>
                      <p className="main-slider__text">
                        We have been operating for over a decade, providing top-notch
                        services to <br /> our clients and building a strong track record in
                      ...
                      <div className="main-slider__btn-and-call-box">
                        ...
                        <div className="main-slider__call">
                          ...
                          <div className="main-slider__call-number">
                            <p>Need help?</p>
                            <h5>
                              <Link to="tel:8969361100">8969361100</Link>                              </h5>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="row">
                  <div className="col-xl-12">
                    <div className="main-slider__content">
                      ...
                      <h2 className="main-slider__title">
                      Innovation, <span> Driven by</span> <br />  Powered by Passion.
                      </h2>
                      <p className="main-slider__text">
                        We have been operating for over a decade, providing top-notch
                        services to <br /> our clients and building a strong track record in
